const preload = () => {
   ...
   //const particle = new THREE.TextureLoader(manager).load('particle1.svg');
}
...
class Environment {
    ...
    createRenderer() {
        ...
        this.renderer = new THREE.WebGLRenderer( { alpha: true } ); // init like this
...
class CreateParticles {
    ...
    onMouseDown() {
        ...
        this.mouse.x = (event.clientX / window.innerWidth) * 2 - 1;
        this.mouse.y = -(event.clientY / window.innerHeight) * 1.5 + 1;
    ...
    render(level) {
        ...
        if (intersects.length > 0) {
            ...
            for (var i = 0, l = pos.count; i < l; i++) {
                ...
                // e.g. red
                this.colorChange.setHSL(36/360, 0, 1)
                ...
                if (this.buttom) {
                    ...
                    if (mouseDistance < this.data.area) {
                        ...
                        if (i % 5 == 0) {
                            ...
                            // e.g. green
                            this.colorChange.setHSL(36/360, 1.0, .5)
                            coulors.setXYZ(i, this.colorChange.r, this.colorChange.g, this.colorChange.b)
                            coulors.needsUpdate = true;
                        ...
                        if ((px > (initX + 10)) || (px < (initX - 10)) || (py > (initY + 10) || (py < (initY - 10)))) {
                            ...
                            this.colorChange.setHSL(22/360, 1.0, .5)
                            coulors.setXYZ(i, this.colorChange.r, this.colorChange.g, this.colorChange.b)
                            coulors.needsUpdate = true;
    ...
    createText() {
        ...
        const yMid = (geometry.boundingBox.max.y - geometry.boundingBox.min.y) / 0.91;
